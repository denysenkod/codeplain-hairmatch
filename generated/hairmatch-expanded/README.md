...
The deployed HairMatch database is bound in `wrangler.toml` as:
...
```text
server.ts                 Cloudflare Worker API and asset routing
wrangler.toml             Worker, assets, and D1 binding configuration
migrations/               D1 schema and seed migrations
frontend/index.html       Single-page app shell
frontend/styles.css       CSS entrypoint
frontend/app.js           JavaScript entrypoint
frontend/css/             Split styles by feature area
frontend/js/              Split frontend logic by feature area
frontend/Images/          Static image assets
scripts/                  Gallery analysis and metadata scripts
test/                     Worker tests
```
